...
public class TransferController extends BaseController {
    ...
    public TransferController(BankingFacade<AccountRequest> accountInformationFacade, BankingFacade<TransferRequest> transferFundFacade) {
        super(accountInformationFacade, transferFundFacade);
    }

    @PostMapping
    public ResponseEntity<Response> transferFunds(@NotNull @Valid @RequestBody TransferRequest transferRequest){
